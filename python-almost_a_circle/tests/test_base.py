...
class TestBase(unittest.TestCase):
    ...
    def test_to_json_string(self):
        ...
        err = (
            "Base.to_json_string() missing 1 required positional argument: " +
            "'list_dictionaries'"
        )
        ...
        err = "Base.to_json_string() takes 1\
    ...
    def test_from_json_string(self):
        ...
        err = ("Base.from_json_string() missing\
                1 required positional argument: " +
               "'json_string'")
        with self.assertRaises(TypeError) as i:
            Base.from_json_string()
        self.assertEqual(err, str(i.exception))
        err = "Base.from_json_string() takes\
